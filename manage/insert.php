            ...
            <div class="card-body">
              <table id="dt-material" class="table table-striped" cellspacing="0" width="100%">
                ...
                <tr>
                    ...
                    <td><input type="text" class="form-control" name="MOTDEPASSE"  placeholder="MOTDEPASSE"></td>
                    <td><input type="text" class="form-control" name="EMAIL" placeholder="EMAIL"></td>
                    <td><input type="text" class="form-control" name="NTelephone" placeholder="NTelephone"></td>
                    <td><input type="text" class="form-control" name="SERVEURIP" placeholder="SERVEURIP"></td>
                    <td>     
